...
class MainWindow(QMainWindow):
    def __init__(self, config_manager: ConfigManager):
        ...
        self.sessions: Dict[Device, PlateSession] = {}
    ...
    def load_plates(self):
        ...
        # Update or create sessions for each device
        for device in self.devices:
            if device not in self.sessions:
                self.sessions[device] = PlateSession(device=device)
    ...
    def on_device_selected(self, device: Device):
        ...
        # find the session for the selected device
    ...
    def select_cmd_component(self, session: PlateSession, cmd_component: CmdComponent):
        ...
        :param session: The session of the device to select the cmd component for.
