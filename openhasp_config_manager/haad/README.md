# haad Integration Utils

This package contains utilities to integrate OpenHASP with haad, a Python-based automation framework for Home Assistant.
...
is efficient and easy to use within HaadControllers.

## Requirements

### haad Environment

Besides making sure haad is properly set up and running (which is already the case
if you use the haad Docker Container), make sure to include the `openhasp-config-manager` package in your haad environment. 
...
from haad import haad_controller

from openhasp_config_manager.haad.controller import OpenHaspController
...
class MyPlateController(OpenHaspController):
