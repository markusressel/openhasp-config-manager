...
class OpenHaspController(HaadController):
    def __init__(self, context: HaadContext):
    ...
    async def initialize(self):
        ...
        self.state_updater = StateUpdater(controller=self)
    ...
    async def __failsafe_plate_setup(self):
        timeout = 10
    ...
    async def __plate_sync_timer_callback(self):
    ...
    async def setup_online_state_listener(self):
        ...
        self._lwt_task = asyncio.create_task(self.plate_controller.listen_openhasp_event(
            path="LWT",
